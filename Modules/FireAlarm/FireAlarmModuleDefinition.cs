        ...
        public ModuleSettings GetDefaultSettings()
        {
            return new ModuleSettings
            {
                ...
                ParameterMappings = new System.Collections.Generic.List<ParameterMapping>
                {
                    ...
                    new ParameterMapping(FireAlarmParameterKeys.CurrentDrawNormal, "Current draw (normal)", isRequired: false),
                    new ParameterMapping(FireAlarmParameterKeys.CurrentDrawAlarm, "Current draw (alarm)", isRequired: false),
